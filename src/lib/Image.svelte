<script>
	...
	export let imgUrl = 'https://placehold.it/1600x900';
...
<div style="width: 100%; aspect-ratio: {aspectRatio}" bind:clientWidth={clientW}>
	<img src={imgSrc} style="width: 100%; height: 100%; object-fit: {objectFit}" {alt} {loading} on:error={(e) => e.target.src = imgUrl} />
</div>